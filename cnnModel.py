...
def genData():
    ...
    numFilter = 2
    CH_NUM_1 = 9
    input = torch.randn([numInput, 1, numRow, dimFeature], requires_grad=False)

    model = CNNModel(dimFeature,numFilter,outputDim)
    re = model(input)
    print re
    print re.shape
